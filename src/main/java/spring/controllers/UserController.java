...
public class UserController {
    ...
    public List<GroupResponseDto> getUsersGroups(@PathVariable Integer userId) {
        logger.info("GET /users/{}/groups request", userId);
        return userService.getUserGroups(userId);
    }

    @PostMapping("/{userId}/groups/{groupId}")
    public List<GroupResponseDto> addUserToGroup(@PathVariable Integer userId,
    ...
    public List<GroupResponseDto> deleteUserToGroup(@PathVariable Integer userId,
                                                    @PathVariable Integer groupId) {
